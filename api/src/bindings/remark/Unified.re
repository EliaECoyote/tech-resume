...
[@bs.module] external run: string => Types.processor = "unified";

[@bs.send]
external use: (Types.processor, Types.plugin) => Types.processor = "use" /* declare function unified<P = unified.Settings>(): unified.Processor<P*/;
